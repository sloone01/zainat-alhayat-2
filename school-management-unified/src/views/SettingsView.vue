          ...
          <div class="flex items-center gap-4">
            ...
            <div class="relative">
              <input
                ...
                class="w-64 ps-10 pe-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
              />
              <svg class="absolute start-3 top-2.5 h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <select
              ...
              :dir="isRTL ? 'rtl' : 'ltr'"
              class="px-4 py-2 border border-gray-300 rounded-lg text-start focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
            >
