    ...
    >
      ...
      >
        <div class="fk-drawer__header items-start">
          <div>
            <h3 class="fk-form__title">{{ $t('roleManagement.filtersTitle') }}</h3>
          </div>
          <button
            type="button"
        ...
        <div class="fk-drawer__body">
          <div class="fk-form__row">
            <label class="fk-flabel" for="roles-search"><span>{{ $t('common.search') }}</span></label>
            <input
              id="roles-search"
              v-model="searchQuery"
              type="search"
          ...
          <div class="fk-form__row">
            <label class="fk-flabel" for="roles-type"><span>{{ $t('roleManagement.groupType') }}</span></label>
            <select
              id="roles-type"
              v-model="typeFilter"
              class="fk-field"
