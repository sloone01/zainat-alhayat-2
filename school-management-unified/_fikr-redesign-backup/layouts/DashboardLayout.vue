    ...
    >
      ...
      <main
        :class="
          props.contentBleed
            ? 'py-0 px-0'
            : 'px-3 py-4 sm:px-6 sm:py-8 lg:px-8'
        "
      >
...
const navigation = computed(() => {
  ...
  if (platformUser) {
    return [
      ...
      {
        name: t('platformFeePayments.nav'),
        href: '/platform/payments',
        icon: 'banknotes',
      },
      {
        name: t('platformFeeTransfers.nav'),
  ...
  if (userRole === 'teacher') {
    return [
      ...
      { id: 'teacher-course-materials', name: t('courseMaterials.navTitle'), href: '/course-materials', icon: 'svg' },
      schoolOperationsNavGroup([
        { name: t('attendanceManagement.title'), href: '/attendance' },
        { name: t('dashboard.activityManagement'), href: '/activities' },
      ]),
  ...
  if (userRole === 'parent') {
    return [
      ...
      {
        name: t('courseMaterials.navTitle'),
        href: '/parent/course-materials',
        icon: 'svg'
      },
      {
