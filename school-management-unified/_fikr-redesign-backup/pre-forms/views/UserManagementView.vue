    ...
    >
      ...
      >
        <div class="fk-drawer__header">
          <h3 class="text-base font-semibold text-fikr-ink">{{ $t('userManagement.filtersTitle') }}</h3>
          <button
            type="button"
        ...
        <div class="flex-1 space-y-5 overflow-y-auto px-4 py-5">
          <div>
            <label class="fk-label" for="users-search">{{ $t('common.search') }}</label>
            <input
              id="users-search"
              v-model="searchQuery"
              type="search"
          ...
          <div>
            <label class="fk-label" for="users-role">{{ $t('userManagement.roles') }}</label>
            <select
              id="users-role"
              v-model="roleFilter"
              class="fk-input"
          ...
          <div>
            <label class="fk-label" for="users-status">{{ $t('userManagement.status') }}</label>
            <select
              id="users-status"
          ...
          <div>
            <label class="fk-label" for="users-date">{{ $t('userManagement.dateFilter') }}</label>
            <select
              id="users-date"
              v-model="dateFilter"
              class="fk-input"
