<template>
  <DashboardLayout>
    <div class="fk-page" :dir="isRTL ? 'rtl' : 'ltr'">
      <FikrPageHeader
        :eyebrow="$t('groupManagement.eyebrow')"
        :title="$t('groupManagement.title')"
        :subtitle="$t('groupManagement.subtitle')"
      />

      <section class="fk-card p-5 sm:p-6">
        <div class="mb-5 flex flex-wrap items-center justify-between gap-3">
          <h2 class="fk-card__title">{{ $t('groupManagement.listHeading') }}</h2>
      ...
      >
        ...
        >
          <div class="fk-drawer__header">
            <h3 class="text-base font-semibold text-fikr-ink">{{ $t('groupManagement.filtersTitle') }}</h3>
            <button
              type="button"
          ...
          <div class="flex-1 space-y-5 overflow-y-auto px-4 py-5">
            <div>
              <label class="fk-label" for="groups-search">
                {{ $t('common.search') }}
              </label>
              <input
                id="groups-search"
            ...
            <div>
              <label class="fk-label" for="groups-status">
                {{ $t('groupManagement.status') }}
              </label>
              <select
                id="groups-status"
