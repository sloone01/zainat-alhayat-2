      ...
      <div class="rounded-2xl border border-gray-200/80 bg-white shadow-sm ring-1 ring-black/[0.02]">
        <div class="border-b border-gray-100 px-4 py-4 sm:px-6 sm:py-5">
          <div class="flex items-center justify-between gap-3">
            <div class="min-w-0">
              <h2 class="truncate text-lg font-semibold text-gray-900">{{ $t('userManagement.listHeading') }}</h2>
    ...
    >
      ...
      >
        <div class="flex items-center justify-between border-b border-gray-200 px-4 py-3">
          <h3 class="text-base font-semibold text-gray-900">{{ $t('userManagement.filtersTitle') }}</h3>
          <button
            type="button"
        ...
        <div class="flex-1 space-y-5 overflow-y-auto px-4 py-5">
          <div>
            <label class="mb-1.5 block text-sm font-medium text-gray-900" for="users-search">{{ $t('common.search') }}</label>
            <input
              id="users-search"
              v-model="searchQuery"
              type="search"
          ...
          <div>
            <label class="mb-1.5 block text-sm font-medium text-gray-900" for="users-role">{{ $t('userManagement.roles') }}</label>
            <select
              id="users-role"
              v-model="roleFilter"
          ...
          <div>
            <label class="mb-1.5 block text-sm font-medium text-gray-900" for="users-status">{{ $t('userManagement.status') }}</label>
            <select
              id="users-status"
          ...
          <div>
            <label class="mb-1.5 block text-sm font-medium text-gray-900" for="users-date">{{ $t('userManagement.dateFilter') }}</label>
            <select
              id="users-date"
              v-model="dateFilter"
              class="w-full rounded-lg border border-gray-200 px-3 py-2.5 text-sm text-gray-900 focus:border-primary-400 focus:outline-none focus:ring-2 focus:ring-primary-500/20"
