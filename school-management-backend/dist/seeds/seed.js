...
class DatabaseSeeder {
    ...
    async linkStudentsToGroups() {
        ...
        const assignments = [
            ...
            { studentName: 'Khalid Salem', groupName: 'Future Leaders' },
            { studentName: 'Lina Al-Otaibi', groupName: 'Bright Minds' },
            { studentName: 'Omar Al-Qahtani', groupName: 'Little Stars' },
            { studentName: 'Nora Al-Mutairi', groupName: 'Creative Explorers' }
        ];
