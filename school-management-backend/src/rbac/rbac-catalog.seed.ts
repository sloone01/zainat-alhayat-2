...
export const RBAC_PAGE_SEED: RbacPageSeed[] = [
  ...
  { key: 'absence_excuses', route: '/attendance/excuses', nameEn: 'Absence excuses', nameAr: 'أعذار الغياب', scope: 'school', sortOrder: 34, actions: ['view', 'approve'] },
  ...
  { key: 'chat_audit', route: '/admin/chat-review', nameEn: 'Conversation review', nameAr: 'مراجعة المحادثات', scope: 'school', sortOrder: 41, actions: ['view', 'search'] },
  ...
  { key: 'parent_absence_excuses', route: '/parent/excuses', nameEn: 'Parent absence excuses', nameAr: 'أعذار ولي الأمر', scope: 'school', sortOrder: 72, actions: ['view', 'create'] },
