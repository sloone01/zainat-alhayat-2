...
--
-- Name: school_management; Type: DATABASE; Schema: -; Owner: school_admin
--
...
ALTER TYPE public.courses_status_enum 
...
ALTER TYPE public.groups_status_enum 
...
ALTER TYPE public.students_gender_enum 
...
ALTER TABLE public.attendances_id_seq 
...
ALTER TABLE public.parents_id_seq 
...
ALTER TABLE public.reminders_id_seq 
...
ALTER TABLE public.staff_id_seq 
...
ALTER TABLE public.student_progress_id_seq 
